...
async function run() {
  ...
  // Copy peach icons as root icons fallback in public/icons/
  ...
  fs.copyFileSync(path.join(peachDir, 'icon-192.svg'), path.join(iconsBaseDir, 'icon-192.svg'));
  fs.copyFileSync(path.join(peachDir, 'icon-512.svg'), path.join(iconsBaseDir, 'icon-512.svg'));
  fs.copyFileSync(path.join(peachDir, 'icon-maskable-192.svg'), path.join(iconsBaseDir, 'icon-maskable-192.svg'));
  fs.copyFileSync(path.join(peachDir, 'icon-maskable-512.svg'), path.join(iconsBaseDir, 'icon-maskable-512.svg'));
